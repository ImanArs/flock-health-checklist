...
export default function HistoryPage() {
  ...
  const handleAddInspection = () => {
    if (newInspection.date.trim() === "" || newInspection.count.trim() === "")
      return;
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewInspection({ ...newInspection, count: e.target.value })
                }
                className="border-red-200 focus:border-red-400"
              />
            </div>
        ...
        <Card className="bg-red-100 border-red-200">
          <CardContent className="p-4 text-center">
            <p className="text-red-700 py-8">
              No inspection records yet. Add your first inspection!
            </p>
          </CardContent>
        </Card>
      ) : (
                  ...
                  <div className="ml-3">
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      <p className="text-sm text-red-700">
                        {inspection.count}{" "}
                        {inspection.count === 1 ? "chicken" : "chickens"}{" "}
                        inspected
                      </p>
                    </div>
                  </div>
