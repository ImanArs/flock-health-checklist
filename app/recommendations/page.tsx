    ...
    <div className="container px-4 py-6 max-w-md mx-auto">
      ...
      <div className="space-y-4">
        {recommendationsData.map((post) => (
          <Card key={post.id} className="overflow-hidden bg-red-100 border-red-200">
            ...
            <CardContent className="p-4">
              <h2 className="text-xl font-bold text-red-900 mb-2">{post.title}</h2>
              <p className="text-red-700 mb-4 line-clamp-2">{post.description}</p>
